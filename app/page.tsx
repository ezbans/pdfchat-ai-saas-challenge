...
const features = [
  {
    ...
    description:
      "Keep your important PDF files stored and easily accessible anytime, anywhere",
    icon: GlobeIcon,
  },
  {
    name: "Blazing fast repsonses",
    description:
  ...
  },
  {
    name: "Cloud Backup",
    description:
      "Rest assuared knowing your documents are safely backed up on the cloud, protected from loss or damage",
    icon: ServerCogIcon,
  },
  {
...
export default function Home() {
  return (
    <main className="flex-1 overflow-scroll p-2 lg:p-5 bg-gradient-to-bl from-white to-indigo-600">
      <div className=" bg-white py-24 sm:py-32 rounded-md drop-shadow-xl flex-col">
        <div className="flex flex-col items-center justify-center max-w-7xl mx-auto px-6 lg:px-8">
          <div className="mx-auto max-w-2xl sm:text-center">
            ...
            <p className=" mt-6 text-lg leading-8 text-gray-600">
              ...
              <span className=" font-bold">dynamic converstations</span>{" "}
        ...
        <div className="mx-auto mt-16 max-w-7xl px-6 sm:mt-20 md:mt-24 lg:px-8">
          <dl
            className="mx-auto grid max-w-2xl grid-cols-1 gap-x-6 gap-y-10 text-base leading-7 text-gray-600 sm:grid-cols-2 lg:mx-10 lg:max-w-none lg:grid-cols-3 lg:gap-x-8
           lg:gap-y-16"
          >
            {features.map((feature, key) => (
              <div key={key} className="relative pl-9">
                <dt className="inline font-semibold to-gray-900">
                  <feature.icon
                    aria-hidden="true"
